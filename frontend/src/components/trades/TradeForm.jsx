...
const TradeForm = ({
  ...
  const [formData, setFormData] = useState({
    ...
    entry: "",
    exit: "",
    size: 0.01, // Default 0.01 lots
    stopLoss: "",
    takeProfit: "",
    tags: "",
    notes: "",
    instrumentType: "gold", // 'forex' or 'gold'
  });
  ...
  const commonInstruments = [
    { symbol: "XAUUSD", name: "Gold", type: "gold", pipValue: 0.1 },
    { symbol: "XAGUSD", name: "Silver", type: "gold", pipValue: 0.1 },
    { symbol: "EURUSD", name: "EUR/USD", type: "forex", pipValue: 0.1 },
    { symbol: "GBPUSD", name: "GBP/USD", type: "forex", pipValue: 0.1 },
    { symbol: "USDJPY", name: "USD/JPY", type: "forex", pipValue: 0.1 },
    { symbol: "AUDUSD", name: "AUD/USD", type: "forex", pipValue: 0.1 },
    { symbol: "USDCAD", name: "USD/CAD", type: "forex", pipValue: 0.1 },
  ];
  ...
  useEffect(() => {
    if (trade && isEditing) {
      setFormData({
        ...
        notes: trade.notes || "",
        instrumentType: trade.instrumentType || "gold",
      });
    }
  }, [trade, isEditing]);
  ...
  const calculatePreview = () => {
    ...
    // Calculate pips
    const pipDiff = Math.abs(exit - entry) * 10000;
    const pips = formData.direction === "Long" ? pipDiff : -pipDiff;
    const pipValue = formData.instrumentType === "gold" ? 0.1 : 0.1;
    const pipProfit = pips * pipValue * size;
  ...
  const handleInstrumentChange = (e) => {
    ...
    const instrument = commonInstruments.find((i) => i.symbol === symbol);
    setFormData((prev) => ({
      ...prev,
      instrument: symbol,
      instrumentType: instrument ? instrument.type : "gold",
    }));
  };
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="form-group md:col-span-2">
              ...
              <input
                ...
                value={formData.tags}
                onChange={handleChange}
                placeholder="e.g., gold, breakout, momentum"
                className="input-dark"
              />
            </div>
