...
-- Add new columns for Forex/Gold trading
ALTER TABLE trades ADD COLUMN IF NOT EXISTS instrument_type VARCHAR(20) DEFAULT 'forex';
ALTER TABLE trades ADD COLUMN IF NOT EXISTS pip_value DECIMAL(10, 6) DEFAULT 0.10;
ALTER TABLE trades ADD COLUMN IF NOT EXISTS pips DECIMAL(10, 2) DEFAULT 0;
ALTER TABLE trades ADD COLUMN IF NOT EXISTS pip_profit DECIMAL(20, 8) DEFAULT 0;
ALTER TABLE trades ADD COLUMN IF NOT EXISTS risk_in_dollars DECIMAL(20, 8) DEFAULT 0;